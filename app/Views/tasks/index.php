                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column justify-content-between">
                                <div class="d-flex flex-row w-100">
                                    <a href="/tasks/<?php echo $task['id']; ?>/edit" class="btn btn-md btn-warning">
                                        <span class="material-icons">edit</span>
                                        Изменить
                                    </a>
                                    <a href="/tasks/<?php echo $task['id']; ?>/delete" class="btn btn-md btn-danger"
                                ...
                                <p class="title is-4">
                                    Добавил: <?php echo auth()->getUsername(); ?>
                                </p>
                                <time datetime="1970-1-1">Запись
                                    добавлена: <?php echo uploadedDate($task['date']); ?></time>
                            </div>
                        </div>
